...
default['riak_cs']['config']['riak_cs']['cs_port'] = 8081
...
default['riak_cs']['config']['riak_cs']['anonymous_user_creation'] = true
...
default['riak_cs']['config']['riak_cs']['cs_root_host'] = "localhost".to_erl_string
